...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Modules\Core\Http\Middleware\PreventRequestsDuringMaintenance::class,
        \Illuminate\Foundation\Http\Middleware\ValidatePostSize::class,
        \Modules\Core\Http\Middleware\TrimStrings::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \Modules\Core\Http\Middleware\HttpsMiddleware::class
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Modules\Core\Http\Middleware\EnsureAppInstalled::class,
        ],
