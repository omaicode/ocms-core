            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-3 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="h5">@lang('core::messages.dashboard.total_visitors')</h2>
                            <h3 class="fw-extrabold mb-1">{{ $analytics->sum('visitors') }}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-9 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">@lang('core::messages.dashboard.total_visitors')</h2>
                            <h3 class="fw-extrabold mb-2">{{ $analytics->sum('visitors') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-3 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="h5">@lang('core::messages.dashboard.total_views')</h2>
                            <h3 class="fw-extrabold mb-1">{{ $analytics->sum('pageViews') }}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-9 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">@lang('core::messages.dashboard.total_views')</h2>
                            <h3 class="fw-extrabold mb-2">{{ $analytics->sum('pageViews') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12">
        <div class="card mb-3">
            <div class="card-header">
                <h5>{{ __('core::messages.statistics') }}</h5>
            </div>
